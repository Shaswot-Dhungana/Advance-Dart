/*
A List in Dart is The
Ordered Collection
of UniQue IteMs.So 
Indexing of Data in a
List is Possible.
*/
...
List myList1 = [1,2,'Nepal',4.5,true];  // We Use Big Bracket in List.
print(myList1);
...
/* Printing Each Element
 of a List Using For in Loop.
*/


for(var a in myList5){
print(a);
}
...
// Add Method (Add Data in List.)

myList6.add(60);
print(myList6);

// Remove Method ( Remove Specific Data/Value From List )
...
// Add Method ( Add  Multiple values in List.)
